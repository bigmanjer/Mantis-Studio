...
## 6. Recent Improvements (Version 84.8)
...
* **Current Version**: 84.8 (stored in `VERSION.txt`)
* **Version Format**: `MAJOR.MINOR` (e.g., 84.8, 84.9, 85.0)
...
2. **Major bump** happens when minor reaches 9 on the next bump
   - Example: 84.9 → 85.0
...
* The Version Bump GitHub Action bumps minor versions on merge
* Use `python scripts/bump_version.py` to increment the minor version locally

### Manual Version Bump

To bump the minor version for the next release:

```bash
python scripts/bump_version.py
```

For major bumps, use the Version Bump workflow dispatch inputs.
