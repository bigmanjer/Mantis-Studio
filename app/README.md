...
- New provider/business logic should go in `app/services/`.
- Secrets, OAuth client secrets, encryption, and token helpers should go in `app/security/`.
- New page-level UI should go in `app/views/` and be wired from `app/main.py` only as needed during migration.
