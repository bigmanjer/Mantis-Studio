...
def _build_footer_nav_links_from_items(nav_items_fn: Callable[[], list[tuple[str, str, str]]]) -> str:
    lines = []
    for label, page_key, icon in nav_items_fn():
        lines.append(
...
def build_footer_nav_links() -> str:
    ...
    return _build_footer_nav_links_from_items(get_nav_items)
...
def render_footer_shared(
    ...
    nav_links_html = build_footer_nav_links()
    brand_logo_src = ""
    try:
